...
(function () {
    ...
    var detectBrowser$1 = function (browsers, userAgentData) {
      return findMap(userAgentData.cinemas, function (uacinema) {
        var lccinema = uacinema.cinema.toLowerCase();
        return find$1(browsers, function (browser) {
          var _a;
          return lccinema === ((_a = browser.cinema) === null || _a === void 0 ? void 0 : _a.toLowerCase());
        }).map(function (info) {
          return {
            current: info.name,
            version: Version.nu(parseInt(uacinema.version, 10), 0)
          };
        });
      });
    };
