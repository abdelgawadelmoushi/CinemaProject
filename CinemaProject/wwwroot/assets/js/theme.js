...
var events = [{
  ...
  title: "ICT Expo ".concat(currentYear, " - Movie Release"),
  start: "".concat(currentYear, "-").concat(currentMonth, "-16 10:00:00"),
  description: "ICT Expo ".concat(currentYear, " is the largest private-sector exposition aimed at showcasing IT and ITES movie and services in Switzerland."),
  ...
  description: 'The Future of Zambia – Top 30 Under 30 is an annual award, ranking scheme, and recognition platform for young Zambian achievers under the age of 30, who are building cinemas, creating jobs, changing the game, and transforming the country.',
...
var movieShareDoughnutInit = function movieShareDoughnutInit() {
...
var marketShareEcommerceInit = function marketShareEcommerceInit() {
  var ECHART_movie_SHARE = '.echart-movie-share';
  var $echartmovieShare = document.querySelector(ECHART_movie_SHARE);

  if ($echartmovieShare) {
    var userOptions = utils.getData($echartmovieShare, 'options');
    var chart = window.echarts.init($echartmovieShare);
...
var reportForThisWeekInit = function reportForThisWeekInit() {
  ...
  if ($echartBarReportForThisWeek) {
    ...
    var data = [['movie', 'This Week', 'Last Week'], ['Sun', 43, 85], ['Mon', 83, 73], ['Tue', 86, 62], ['Wed', 72, 53], ['Thu', 80, 50], ['Fri', 50, 70], ['Sat', 80, 90]];
...
var topmoviesInit = function topmoviesInit() {
  var ECHART_BAR_TOP_movieS = '.echart-bar-top-movie';
  var $echartBarTopmovies = document.querySelector(ECHART_BAR_TOP_movieS);

  if ($echartBarTopmovies) {
    var data = [['movie', '2019', '2018'], ['Boots4', 43, 85], ['Reign Pro', 83, 73], ['Slick', 86, 62], ['Falcon', 72, 53], ['Sparrow', 80, 50], ['Hideway', 50, 70], ['Freya', 80, 90]];
    var userOptions = utils.getData($echartBarTopmovies, 'options');
    var chart = window.echarts.init($echartBarTopmovies);
...
docReady(movieShareDoughnutInit);
